...
fn main() {
    ...
    let url = CString::new(url).expect("valid string");
    ...
    unsafe {
        ...
        curl_easy_setopt(
            ...
            CurlParameter { pointer: url.as_c_str().as_ptr() as _ },
        );
...
extern "C" {
    ...
    fn curl_easy_setopt(handle: *mut CURL, option: CURLoption, parameter: CurlParameter) -> CURLcode;
