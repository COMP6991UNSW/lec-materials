...
extern "C" {
    ...
    fn curl_easy_setopt(handle: *mut CURL, option: CURLoption, parameter: *mut c_void) -> CURLcode;
...
fn main() {
    ...
    unsafe {
        ...
        curl_easy_setopt(curl, CURLoption::CURLOPT_URL, string.as_c_str().as_ptr() as _);
